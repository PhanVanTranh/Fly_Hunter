 ...
 *   EEPROM_SCORE_START_ADDR   -> ar_game_score_eeprom_t
 *   EEPROM_SETTING_START_ADDR -> ar_game_setting_eeprom_t
 *
...
static void ar_game_score_set_default(ar_game_score_t *data) {
	data->score_now = 0;
	data->score_1st = 0;
	data->score_2nd = 0;
	data->score_3rd = 0;
...
static void ar_game_setting_set_default(ar_game_setting_t *data) {
